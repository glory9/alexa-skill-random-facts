...
const data = {
    ...
    FACTS: [
        'Glory likes computers and math and c++.',
        'Glory was born and raised in Ilorin, Nigeria.',
        'Glory plays the piano at church.',
        'Glory loves chicken. Oh. Wait. Everyone loves chicken.',
        'Glory plays chess for fun.',
        'Glory believes in dignity and hard work.',
    ],
}
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = 'Welcome, you can say: tell me about glory or what do you know about glory ';

        return handlerInput.responseBuilder
            .speak(speakOutput)
            .reprompt(data.SKILL_NAME, speakOutput)
            .getResponse();
    },
};
